...
RandomizedSearchCV를 이용하여 Random Forest의 최적 하이퍼파라미터를 탐색하였다.

Recall을 기준(scoring="recall")으로 5-Fold Cross Validation을 수행하였다.

불균형 데이터에서 Accuracy보다 실제 Failure를 놓치지 않는 것이 중요하다고 판단하여 Recall을 평가 지표로 설정하였다.
...
![1787810446842](image/2차-2/1787810446842.png)
